...
public class DemoController {
    ...
    public Map<String, Object> health() {
        return Map.of("service", "ms-shipping", "status", "ok", "timestamp", OffsetDateTime.now().toString());
    }

    @GetMapping("/log")
    public Map<String, String> log() {
        // Evento de log nivel ERROR: lo captura el appender sentry-logback -> GlitchTip.
        log.error("[DEMO] Evento de log de prueba enviado a GlitchTip desde ms-shipping");
    ...
    public Map<String, String> error() {
        ...
        throw new RuntimeException("[DEMO] Excepcion de prueba para GlitchTip desde ms-shipping");
    }
}
